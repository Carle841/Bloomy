      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3 footer_about">
            <a class="logo h3" href="/bloomy.html">
            ...
            <div class="wrapper mt-3">
              ...
              <p class="footer_about-copyright text--sm">
                Bloomy © Todos los Derechos Reservados <span>{{ anio }}</span>
              </p>
            </div>
          </div>
          ...
          <div class="col-md-3 footer_block">
            ...
            <ul class="footer_block-socials d-flex list-unstyled">
              ...
              <li>
                <a class="https://www.instagram.com" class="fab fa-instagram" target="_blank"></a>
                </li>
            </ul>
          </div>
        </div>
