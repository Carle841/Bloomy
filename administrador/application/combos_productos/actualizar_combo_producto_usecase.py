...
class ActualizarComboProductoUseCase:
    def __init__(
        self,
    ...
    def execute(self, combo_id: int, producto_id: int, cantidad: int):
        ...
        # Calcular subtotal
        subtotal = cantidad * producto.get_precio()

        # Crear ComboProducto actualizado
        combo_producto_actualizado = ComboProducto(
            combo_id=combo_id,
        ...
        # Actualizar ComboProducto
        self.combo_producto_repo.store(combo_producto_actualizado)
