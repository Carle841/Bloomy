...
from administrador.application.articulo_service import ArticulosService
from administrador.domain.articulo import Articulo
from administrador import app
from administrador import db

@app.route("/api/articulos/create", methods=["POST"])
def articulos_api_create():
    
    if request.method == "POST":
        articulos_repository = UsuarioRepositoryPgImpl(db)
